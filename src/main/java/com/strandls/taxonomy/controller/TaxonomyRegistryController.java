...
public class TaxonomyRegistryController {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(
                ...
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = BreadCrumb.class)))
            ),
            @ApiResponse(
                responseCode = "404",
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(
                ...
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = TaxonTree.class)))
            ),
            @ApiResponse(
                responseCode = "400",
    ...
    public Response getTaxonTree(
        ...
        @QueryParam("taxonList") String taxonList
    ) {
        try {
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(
                ...
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = TaxonRelation.class)))
            ),
            @ApiResponse(
                responseCode = "400",
