...
public class SpeciesGroupController {
    ...
    public Response addSpeciesGroup(
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(
                ...
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = SpeciesGroup.class)))
            ),
            @ApiResponse(
                responseCode = "404",
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(
                ...
                content = @Content(array = @ArraySchema(schema = @Schema(implementation = SpeciesPermission.class)))
            ),
            @ApiResponse(
                responseCode = "400",
