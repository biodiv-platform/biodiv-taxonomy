...
public class TaxonomyDefinitionController {
  ...
  @Inject private TaxonomyDefinitionSerivce taxonomyService;

  @Inject private TaxonomyDefinitionDao taxonomyDefinitionDao;

  @Inject private TaxonomyESOperation taxonomyESOperation;

  @GET
  @Path("/{taxonomyConceptId}")
  @Consumes(MediaType.TEXT_PLAIN)
  @Operation(
      summary = "Find Taxonomy by ID",
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  public Response getTaxonomyConceptName(
      @Parameter(description = "Taxonomy Concept ID", required = true)
          @PathParam("taxonomyConceptId")
          String taxonomyConceptId) {
    try {
  ...
  @Consumes(MediaType.TEXT_PLAIN)
  @Operation(
      summary = "Find Taxonomy Details by ID",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Taxonomy details",
            content = @Content(schema = @Schema(implementation = TaxonomyDefinitionShow.class))),
        @ApiResponse(
            responseCode = "404",
            description = "Taxonomy not found",
            content = @Content(schema = @Schema(implementation = String.class)))
  ...
  @Consumes(MediaType.TEXT_PLAIN)
  @Operation(
      summary = "Get taxonomy name list",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Taxonomy Name List",
            content = @Content(schema = @Schema(implementation = TaxonomyNameListResponse.class))),
        @ApiResponse(
            responseCode = "404",
            description = "Taxonomy list not found",
            content = @Content(schema = @Schema(implementation = String.class)))
      })
  public Response getTaxonomyNameList(
      @Context HttpServletRequest request,
      @Parameter(description = "Taxon ID") @QueryParam("taxonId") Long taxonId,
      @Parameter(description = "Classification ID") @QueryParam("classificationId")
      ...
      @Parameter(description = "Limit", example = "-1") @DefaultValue("-1") @QueryParam("limit")
          Integer limit,
      @Parameter(description = "Offset", example = "-1") @DefaultValue("-1") @QueryParam("offset")
          Integer offset) {
    try {
      TaxonomyNameListResponse response =
          taxonomyService.getTaxonomyNameList(
  ...
  @Operation(
      summary = "Upload the file for taxon definition",
      requestBody =
          @RequestBody(
              required = true,
              description = "Multi-part form data with file and associated info"),
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  @Consumes({MediaType.MULTIPART_FORM_DATA})
  @Operation(
      summary = "Upload the file for taxon definition search",
      requestBody =
          @RequestBody(required = true, description = "Multi-part file for name matching"),
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Success/failure as a map",
  ...
  @ValidateUser
  @Operation(
      summary = "Save the taxonomy list",
      requestBody =
          @RequestBody(
              required = true,
              content =
                  @Content(
                      array = @ArraySchema(schema = @Schema(implementation = TaxonomySave.class)))),
      responses =
          @ApiResponse(
              responseCode = "200",
              ...
              content =
                  @Content(
                      array =
                          @ArraySchema(
                              schema = @Schema(implementation = TaxonomyDefinition.class)))))
  public Response saveTaxonomyList(
      @Context HttpServletRequest request, List<TaxonomySave> taxonomyList) {
    try {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(
      summary = "Get taxonomy based on the canonical name and rank",
      responses =
          @ApiResponse(
              responseCode = "200",
              description = "Found taxonomy",
              content = @Content(schema = @Schema(implementation = TaxonomySearch.class))))
  public Response getByNameSearch(
      @Parameter(description = "Scientific Name") @QueryParam("scientificName")
  ...
  @Transactional
  @Operation(
      summary = "Search taxonomy based on the name",
      responses =
          @ApiResponse(
              responseCode = "200",
              description = "Found taxonomy search result",
  ...
  @Transactional
  @Operation(
      summary = "Search taxonomy based on the Ids",
      responses =
          @ApiResponse(
              responseCode = "200",
              description = "Found taxonomy",
  ...
  public Response specificSearch(
      @Parameter(description = "Search term") @QueryParam("term") String term,
      @Parameter(description = "Classification ID") @QueryParam("classification")
          Long classificationId,
      @Parameter(description = "Taxon ID") @QueryParam("taxonid") Long taxonid) {
    try {
  ...
  @Consumes(MediaType.TEXT_PLAIN)
  @Operation(
      summary = "Get the common name and synonyms",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Taxonomic names based on taxonomyId",
            content = @Content(schema = @Schema(implementation = TaxonomicNames.class))),
        @ApiResponse(
            responseCode = "400",
            description = "unable to get the names",
            content = @Content(schema = @Schema(implementation = String.class)))
      })
  public Response getNames(
      @Parameter(description = "Taxonomy ID", required = true) @PathParam("taxonomyId")
          String taxonomyId) {
    try {
  ...
  @Consumes(MediaType.TEXT_PLAIN)
  @Operation(
      summary = "Update the name of taxonomy",
      requestBody = @RequestBody(required = true, description = "The new scientific name"),
      responses =
          @ApiResponse(
              responseCode = "200",
  ...
  public Response updateName(
    ...
    try {
      TaxonomyDefinitionShow taxonomyDefinitionShow =
          taxonomyService.updateName(request, taxonId, taxonName);
      return Response.status(Status.OK).entity(taxonomyDefinitionShow).build();
    } catch (Exception e) {
      throw new WebApplicationException(
          Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity(e.getMessage()).build());
  ...
  @Path("status")
  @Operation(
      summary = "Update the taxonomy status (accepted or synonym)",
      requestBody =
          @RequestBody(
              required = true,
              content = @Content(schema = @Schema(implementation = TaxonomyStatusUpdate.class))),
      responses =
          @ApiResponse(
              responseCode = "200",
              description = "Updated taxonomy status",
              content = @Content(schema = @Schema(implementation = TaxonomyDefinitionShow.class))))
  @ValidateUser
  public Response updateStatus(
      @Context HttpServletRequest request, TaxonomyStatusUpdate taxonomyStatusUpdate) {
    try {
      TaxonomyDefinitionShow taxonomyDefinitionShow =
          taxonomyService.updateStatus(request, taxonomyStatusUpdate);
      return Response.status(Status.OK).entity(taxonomyDefinitionShow).build();
    } catch (Exception e) {
      throw new WebApplicationException(
          Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity(e.getMessage()).build());
  ...
  @Path("position")
  @Operation(
      summary = "Update the position of taxonomy (raw or working)",
      requestBody =
          @RequestBody(
              required = true,
              content = @Content(schema = @Schema(implementation = TaxonomyPositionUpdate.class))),
      responses =
          @ApiResponse(
              responseCode = "200",
              description = "Updated taxonomy position",
              content = @Content(schema = @Schema(implementation = TaxonomyDefinitionShow.class))))
  @ValidateUser
  public Response updatePosition(
      @Context HttpServletRequest request, TaxonomyPositionUpdate taxonomyPositionUpdate) {
    try {
      TaxonomyDefinitionShow taxonomyDefinitionShow =
          taxonomyService.updatePosition(request, taxonomyPositionUpdate);
      return Response.status(Status.OK).entity(taxonomyDefinitionShow).build();
    } catch (Exception e) {
      throw new WebApplicationException(
          Response.status(Response.Status.INTERNAL_SERVER_ERROR).entity(e.getMessage()).build());
  ...
  @ValidateUser
  @Operation(
      summary = "Update and add synonyms to taxonomy",
      requestBody =
          @RequestBody(
              required = true,
      ...
      responses =
          @ApiResponse(
              responseCode = "200",
              description = "Updated synonyms",
              content =
                  @Content(
                      array =
                          @ArraySchema(
                              schema = @Schema(implementation = TaxonomyDefinition.class)))))
  public Response updateAddSynonym(
      @Context HttpServletRequest request,
    ...
    try {
      ...
      List<TaxonomyDefinition> result =
          taxonomyService.updateAddSynonym(request, sId, tId, synonymData);
      return Response.status(Status.OK).entity(result).build();
    } catch (Exception e) {
      return Response.status(Status.BAD_REQUEST).entity(e.getMessage()).build();
    }
  ...
  @ValidateUser
  @Operation(
      summary = "Delete synonym for a taxonomy",
      responses =
          @ApiResponse(
              responseCode = "200",
              description = "List of available synonyms",
              content =
                  @Content(
                      array =
                          @ArraySchema(
  ...
  public Response removeSynonyms(
      ...
      @Parameter(description = "Species ID") @QueryParam("speciesId") String speciesId,
      @Parameter(description = "Taxon ID", required = true) @PathParam("taxonId") String taxonId,
      @Parameter(description = "Synonym ID", required = true) @PathParam("synonymId")
          String synonymId) {
    try {
      Long sId = speciesId != null ? Long.parseLong(speciesId) : null;
      Long tId = Long.parseLong(taxonId);
  ...
  @ValidateUser
  @Operation(
      summary = "Update the elastic index for taxon",
      responses =
          @ApiResponse(
              responseCode = "200",
              description = "Elastic index updated",
              content =
                  @Content(
                      array =
                          @ArraySchema(schema = @Schema(implementation = MapQueryResponse.class)))))
  public Response updateElastic(
      @Context HttpServletRequest request,
      @Parameter(description = "Comma separated Taxon IDs") @QueryParam("taxonIds")
          String taxonIdsString) {
    try {
      if (TaxonomyUtil.isAdmin(request)) {
        List<Long> taxonIds =
            Arrays.asList(taxonIdsString.split(",")).stream()
                .map(Long::parseLong)
        ...
        throw new WebApplicationException(
            Response.status(Response.Status.UNAUTHORIZED)
                .entity("Only admin can do the reindex")
                .build());
      }
    } catch (Exception e) {
      throw new WebApplicationException(
  ...
  @ValidateUser
  @Operation(
      summary = "Reindex the complete elastic for all taxon Ids",
      responses =
          @ApiResponse(
              responseCode = "200",
              description = "Elastic index reindexed",
              content =
                  @Content(
                      array =
                          @ArraySchema(schema = @Schema(implementation = MapQueryResponse.class)))))
  ...
  @ValidateUser
  @Operation(
      summary = "Update Italicised form for all the taxonomy definition",
      responses =
          @ApiResponse(
              responseCode = "200",
              description = "Map of taxonomy definitions",
              content = @Content(schema = @Schema(implementation = Map.class))))
  public Response updateItalicisedForm(@Context HttpServletRequest request) {
    try {
      if (TaxonomyUtil.isAdmin(request)) {
        ...
        throw new WebApplicationException(
            Response.status(Response.Status.UNAUTHORIZED)
                .entity("Only admin can do the complete update of the name")
                .build());
      }
    } catch (Exception e) {
      throw new WebApplicationException(
