...
public class TaxonomyDefinitionController {
    ...
    public Response getTaxonomyNameList(
        ...
        try {
            TaxonomyNameListResponse response = taxonomyService.getTaxonomyNameList(taxonId, classificationId, rankList, statusList, positionList, limit, offset);
    ...
    @Operation(
        ...
        requestBody = @RequestBody(required = true, description = "Multi-part file for name matching"),
        responses = {
    ...
    @Operation(
        ...
        requestBody = @RequestBody(
            required = true,
            content = @Content(array = @ArraySchema(schema = @Schema(implementation = TaxonomySave.class)))
        ),
        responses = @ApiResponse(responseCode = "200", description = "Saved list", content = @Content(array = @ArraySchema(schema = @Schema(implementation = TaxonomyDefinition.class))))
    )
    public Response saveTaxonomyList(
        @Context HttpServletRequest request,
        List<TaxonomySave> taxonomyList) {
        try {
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Saved Taxonomy", content = @Content(schema = @Schema(implementation = TaxonomyDefinition.class)))
    )
    public Response saveTaxonomy(
        @Context HttpServletRequest request,
        TaxonomySave taxonomySave) {
        try {
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Found taxonomy", content = @Content(schema = @Schema(implementation = TaxonomySearch.class)))
    )
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Found taxonomy search result", content = @Content(schema = @Schema(implementation = Object.class)))
    )
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Found taxonomy", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class))))
    )
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Updated taxonomy", content = @Content(schema = @Schema(implementation = TaxonomyDefinitionShow.class)))
    )
    @ValidateUser
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Updated taxonomy status", content = @Content(schema = @Schema(implementation = TaxonomyDefinitionShow.class)))
    )
    @ValidateUser
    public Response updateStatus(
        @Context HttpServletRequest request,
        TaxonomyStatusUpdate taxonomyStatusUpdate) {
        try {
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Updated taxonomy position", content = @Content(schema = @Schema(implementation = TaxonomyDefinitionShow.class)))
    )
    @ValidateUser
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Updated synonyms", content = @Content(array = @ArraySchema(schema = @Schema(implementation = TaxonomyDefinition.class))))
    )
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "List of available synonyms", content = @Content(array = @ArraySchema(schema = @Schema(implementation = TaxonomyDefinition.class))))
    )
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Elastic index updated", content = @Content(array = @ArraySchema(schema = @Schema(implementation = MapQueryResponse.class))))
    )
    public Response updateElastic(
        ...
        try {
            if (TaxonomyUtil.isAdmin(request)) {
                List<Long> taxonIds = Arrays.asList(taxonIdsString.split(",")).stream().map(Long::parseLong).collect(Collectors.toList());
                ...
                throw new WebApplicationException(Response.status(Response.Status.UNAUTHORIZED).entity("Only admin can do the reindex").build());
            }
        } catch (Exception e) {
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Elastic index reindexed", content = @Content(array = @ArraySchema(schema = @Schema(implementation = MapQueryResponse.class))))
    )
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Logged comment", content = @Content(schema = @Schema(implementation = Activity.class)))
    )
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "Map of taxonomy definitions", content = @Content(schema = @Schema(implementation = Map.class)))
    )
