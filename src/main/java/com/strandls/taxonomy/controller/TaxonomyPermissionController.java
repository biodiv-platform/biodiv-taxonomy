...
public class TaxonomyPermissionController {
    ...
    @Operation(
        ...
        responses = @ApiResponse(responseCode = "200", description = "PONG", content = @Content(schema = @Schema(implementation = String.class)))
    )
    ...
    @Operation(
        ...
        requestBody = @RequestBody(required = true, content = @Content(schema = @Schema(implementation = PermissionData.class))),
        responses = {
    ...
    @Operation(
        ...
        requestBody = @RequestBody(required = true, content = @Content(schema = @Schema(implementation = EncryptedKey.class))),
        responses = {
