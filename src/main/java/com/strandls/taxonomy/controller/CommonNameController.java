...
public class CommonNameController {
  ...
  @Inject private CommonNameSerivce commonNameService;

  @GET
  @Path("{id}")
  @Consumes(MediaType.APPLICATION_JSON)
  @Operation(
      summary = "Get the common name",
      description = "Get a specific common name by ID",
      responses = {
        @ApiResponse(
            responseCode = "200",
        ...
        @ApiResponse(
            responseCode = "404",
            description = "Could not find the common name",
            content = @Content(schema = @Schema(implementation = String.class)))
      })
  public Response getCommonName(
  ...
  @Operation(
      ...
      description = "Get all common names for a given taxon ID",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "All common names for a taxon",
            content =
                @Content(
                    array = @ArraySchema(schema = @Schema(implementation = CommonName.class)))),
        @ApiResponse(
            responseCode = "404",
            description = "Could not find the common name",
            content = @Content(schema = @Schema(implementation = String.class)))
      })
  public Response getCommonNameForTaxonId(
      @Context HttpServletRequest request,
  ...
  @ValidateUser
  @Operation(
      summary = "Add a common name",
      description = "Save a new common name",
      requestBody =
          @RequestBody(
              required = true,
              content = @Content(schema = @Schema(implementation = CommonName.class))),
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "The new common name",
            content = @Content(schema = @Schema(implementation = CommonName.class))),
        @ApiResponse(
            responseCode = "404",
            description = "Could not add common name",
            content = @Content(schema = @Schema(implementation = String.class)))
      })
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Operation(
      summary = "Get the preferred common name for a taxon",
      description = "Returns the preferred common name for a given taxon ID",
      responses = {
        @ApiResponse(
            responseCode = "200",
        ...
        @ApiResponse(
            responseCode = "404",
            description = "Preferred common name is not set",
            content = @Content(schema = @Schema(implementation = String.class)))
      })
  public Response getPrefferedCommanName(
      @Context HttpServletRequest request,
      @Parameter(description = "Taxon ID") @QueryParam("taxonId") Long taxonId) {
    try {
  ...
  @ValidateUser
  @Operation(
      summary = "Update the preferred common name",
      description = "Set a common name to be preferred",
      requestBody =
          @RequestBody(
              required = true,
              description = "Common name ID (as raw long in body)",
              content = @Content(schema = @Schema(implementation = Long.class))),
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Updated preferred common name",
            content = @Content(schema = @Schema(implementation = CommonName.class))),
        @ApiResponse(
            responseCode = "404",
            description = "Could not set the common name to preferred",
            content = @Content(schema = @Schema(implementation = String.class)))
      })
  ...
  @ValidateUser
  @Operation(
      summary = "Update/add common names for a species",
      description = "Add or update a set of common names for a species",
      requestBody =
          @RequestBody(
              required = true,
      ...
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "The new list of common names",
            content =
                @Content(
                    array = @ArraySchema(schema = @Schema(implementation = CommonName.class)))),
        @ApiResponse(
            responseCode = "400",
            description = "Unable to update the common name",
            content = @Content(schema = @Schema(implementation = String.class)))
      })
  public Response updateAddCommonNames(
      @Context HttpServletRequest request,
      @Parameter(description = "Species ID") @QueryParam("speciesId") String speciesId,
      CommonNamesData commonNamesData) {
    try {
      Long sId = null;
      if (speciesId != null) sId = Long.parseLong(speciesId);
      List<CommonName> result =
          commonNameService.updateAddCommonName(request, sId, commonNamesData);
  ...
  @ValidateUser
  @Operation(
      summary = "Remove a common name",
      description = "Remove a common name for a given species, by ID",
      responses = {
        @ApiResponse(
            responseCode = "200",
            description = "Deleted (remaining) common names",
            content =
                @Content(
                    array = @ArraySchema(schema = @Schema(implementation = CommonName.class)))),
        @ApiResponse(
            responseCode = "400",
            description = "Unable to remove the common name",
            content = @Content(schema = @Schema(implementation = String.class)))
      })
  public Response removeCommonName(
      @Context HttpServletRequest request,
      @Parameter(description = "Species ID") @QueryParam("speciesId") String speciesId,
      @Parameter(description = "Common name ID", required = true) @PathParam("commonNameId")
          String commonNameId) {
    try {
