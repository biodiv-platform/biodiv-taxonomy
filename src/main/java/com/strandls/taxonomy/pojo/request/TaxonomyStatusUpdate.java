 ...
 * @param hierarchy - This will be null for the accepted name to synonym change
 * @param newTaxonId - This will be null for the synonym to accepted name change.
 * @return
 */
public class TaxonomyStatusUpdate {
  ...
  public TaxonomyStatusUpdate(
      Long taxonId, TaxonomyStatus status, List<Long> newTaxonId, Map<String, String> hierarchy) {
    super();
