...
public class TaxonomyRegistry implements Serializable, Cloneable {
    ...
    public Long getTaxonomyDefinationId() { return taxonomyDefinationId; }
    public void setTaxonomyDefinationId(Long taxonomyDefinationId) { this.taxonomyDefinationId = taxonomyDefinationId; }
