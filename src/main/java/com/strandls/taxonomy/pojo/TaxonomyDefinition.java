...
@Schema(
    description =
        "Full Taxonomy Definition entity: canonical info, authorship, system mapping, and status")
@SqlResultSetMapping(
    name = "TaxonomyNameList",
    classes = {
      @ConstructorResult(
...
public class TaxonomyDefinition {
  ...
  @Schema(
      description = "Canonical (normalized, stripped) form",
      required = true,
      example = "Homo sapiens")
  private String canonicalForm;

  @Schema(
      description = "Italicised form, for web display",
      required = true,
      example = "<i>Homo sapiens</i>")
  ...
  @Schema(
      description = "Original name as entered",
      required = true,
  ...
  @GeneratedValue(
      ...
      generator = "taxonomy_definition_id_generator")
  @SequenceGenerator(
      name = "taxonomy_definition_id_generator",
      sequenceName = "taxonomy_definition_id_seq",
      allocationSize = 1)
  @Column(name = "id")
  public Long getId() {
    return id;
