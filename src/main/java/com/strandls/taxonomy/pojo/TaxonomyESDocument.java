...
@SqlResultSetMapping(
    name = "TaxonomyESDocumentMapping",
    entities = {
        @EntityResult(
            entityClass = TaxonomyESDocument.class,
            fields = {
...
public class TaxonomyESDocument {
    ...
    public TaxonomyESDocument(
            Long id, String name, String canonical_form, String italicised_form, String rank,
    ...
    public String getCanonical_form() { return canonical_form; }
    public void setCanonical_form(String canonical_form) { this.canonical_form = canonical_form; }

    public String getItalicised_form() { return italicised_form; }
    public void setItalicised_form(String italicised_form) { this.italicised_form = italicised_form; }
    ...
    public List<JsonNode> getHierarchy() { return hierarchy; }
    public void setHierarchy(List<JsonNode> hierarchy) { this.hierarchy = hierarchy; }

    public List<Long> getAccepted_ids() { return accepted_ids; }
    public void setAccepted_ids(List<Long> accepted_ids) { this.accepted_ids = accepted_ids; }

    public List<String> getAccepted_names() { return accepted_names; }
    public void setAccepted_names(List<String> accepted_names) { this.accepted_names = accepted_names; }

    public List<JsonNode> getCommon_names() { return common_names; }
    public void setCommon_names(List<JsonNode> common_names) { this.common_names = common_names; }
