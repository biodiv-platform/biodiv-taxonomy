...
@Schema(
    description = "ES document view for taxonomy, including hierarchy, relations, and group info")
public class TaxonomyESDocument {
  ...
  @Schema(
      description = "Accepted taxon names (array)",
      example = "[\"Quercus alba\",\"Quercus robur\"]")
  ...
  public TaxonomyESDocument(
      ...
      String italicised_form,
      String rank,
      String status,
      String position,
      String path,
      List<JsonNode> hierarchy,
      List<Long> accepted_ids,
      List<String> accepted_names,
      List<JsonNode> common_names,
      Long group_id,
      String group_name) {
    this.id = id;
    this.name = name;
