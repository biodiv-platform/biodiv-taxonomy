...
public class MailUtils {
  ...
  @Inject private RabbitMQProducer mailProducer;
  ...
  public void sendPermissionRequest(
    ...
    for (User requestor : requestors) {
      if (requestor.getEmail() != null) emailList.add(requestor.getEmail());
    }
    try {
      ...
      mailProducer.produceMail(
          RabbitMqConnection.EXCHANGE_BIODIV,
          RabbitMqConnection.MAIL_ROUTING_KEY,
          null,
